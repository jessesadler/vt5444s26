...
[^1]: R is a [REPL (read-eval-print loop)](https://en.wikipedia.org/wiki/Read–eval–print_loop) based language. It is primarily focused on running interactively, one line at a time.
