...
Check out a small [example DH website with Quarto](https://jessesadler.github.io/quarto-web-example/). The [GitHub repository](https://github.com/jessesadler/quarto-web-example) for the site shows how it is made.

There are a lot of Quarto websites out in the world. Explore the [gallery of websites](https://quarto.org/docs/gallery/#websites) on the Quarto site for inspiration.

A couple that you might want to look at include:
