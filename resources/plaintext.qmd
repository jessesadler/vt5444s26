...
- **The power of a text editor**: With a text editor application you can perform all sorts of complex search and search and replace functionality across multiple documents at the same time. See the [Text editors guide](text-editors.qmd).
...
- [Obsidian](https://obsidian.md) is the most popular choice. It has a large following and is highly customizable. Obsidian is free but not open source.
- [Tangent Notes](https://www.tangentnotes.com) is an open source alternative.
- [iA Writer](https://ia.net/writer) is a paid application available for Windows and MacOS, as well as iOS. It is a very good looking simple application for writing Markdown.
