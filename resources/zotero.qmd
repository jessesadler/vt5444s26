...
- Built by and for the humanities. It is a project created and maintained by a group called [Digital Scholar](https://digitalscholar.org) that also maintains [Omeka](https://omeka.org/) and [Tropy](https://tropy.org/). It came out of the DH group at George Mason University.
- Syncs across devices. There is a web version and iOS version.
- Ability to collaborate through shared groups.

### Things to keep in mind
- Bibliographic managers are an investment. The time to learn how to use them is early in the writing and research process, not right before you turn in a paper. If you just want styled citations, there are other tools like [ZoteroBib](https://zbib.org).
- Take time to read the [documentation](https://www.zotero.org/support/).
...
Check out these resources from the Library on Zotero, including former workshops with step-by-step guides and slides with screenshots for working with Zotero. These resources produced by Lisa Becksford Russell provides a basis upon which this document builds: [Zotero Research Guide](https://guides.lib.vt.edu/citationmanagers/Zotero)
...
### Quarto
You can also use Zotero to style citations in plaintext documents with Quarto. See [Citations with Quarto](quarto-citations.qmd) for more information.
