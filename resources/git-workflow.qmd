...
2. Add the changes to the **stage** that you want to be part of a commit.
3. **Commit** the staged files with a message about the changes.
3. Repeat steps 1–3 until you feel you have made good progress.
