...
2. Add the GitHub repository as a remote server
    ...
    2. In the Terminal tab of the RStudio project that you are connecting to GitHub run `git remote add origin https://github.com/jessesalder/r-notes.git`.
...
4. Check that changes propagated to GitHub.
    1. Celebrate 🎉 your success if they did.
